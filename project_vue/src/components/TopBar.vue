<template>
  <v-app-bar app class="topbar">
    ...
    <div class="button-container">
      ...
      <v-btn class="flex-button" text @click="navigateTo('board')"
        >게시판</v-btn
      >
      <v-btn class="flex-button" text @click="navigateTo('mypage')"
        >마이페이지</v-btn
      >
      <v-btn class="flex-button" text @click="navigateTo('recommendation')"
        >맞춤 동네 추천</v-btn
      >
    </div>
